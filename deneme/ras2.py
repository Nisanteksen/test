...
import numpy
import time
from gpiozero import LED #pinlere erişim sağladık gpiozero, Python programlama dili için bir GPIO arayüzü sağlayan bir kütüphanedir. 
